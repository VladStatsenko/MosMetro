...
public class Main {
    private final static String URL = "https://clck.ru/MCHxP";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Основные станции
        parseStations(doc, NUM_ON_PAGE);
        // Монорельс
        parseStations(doc, NUM_ON_PAGE + 1);
        // Центральное кольцо
        parseStations(doc, NUM_ON_PAGE + 2);
        ...
        try {
            System.out.println(ReadJson.readJ("src/main/resources/map.json"));
        } catch (ParseException e) {
            e.printStackTrace();
        }
    }

    private static void parseStations(Document doc, int numOfTableOnPage) {
